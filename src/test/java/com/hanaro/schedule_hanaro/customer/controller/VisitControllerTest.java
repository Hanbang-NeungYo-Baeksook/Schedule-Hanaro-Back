...
// 		CreateVisitResponse createVisitResponse = visitService.addVisitReservation(
// 				VisitCreateRequest.builder()
// 						.customerId(customer.getId())
...
//
// 		String url = "/api/visits/" + createVisitResponse.visitId();
// 		ResultActions result = mockMvc.perform(get(url));
//
// 		result.andExpect(status().isOk())
// 			.andExpect(content().contentType(MediaType.APPLICATION_JSON))
// 			.andExpect(jsonPath("$.visit_id").value(createVisitResponse.visitId()))
...
// 	@Test
// 	@Order(5)
// 	public void getVisitListTest() throws Exception {
// 		Customer customer = customerRepository.findByName("TestUser3").orElseThrow();
// 		Authentication authentication = new UsernamePasswordAuthenticationToken(customer.getId(), null);
// 		List<Branch> branchList = new ArrayList<>();
// 		branchList.add(branchRepository.findByName("NormalTestBranch1").orElseThrow());
...
// 		branchList.add(branchRepository.findByName("NormalTestBranch3").orElseThrow());
//
// 		// Add visit reservations
// 		for (Branch branch : branchList) {
// 			visitService.addVisitReservation(VisitCreateRequest.builder()
// 					.branchId(branch.getId())
// 					.content("Test Content")
// 					.category(Category.SIGNIN)
...
// 		}
//
// 		String url = "/api/visits?page=1&size=10";
//
// 		ResultActions result = mockMvc.perform(get(url)
...
// 		result.andExpect(status().isOk())
// 				.andExpect(jsonPath("$.data").exists())
// 				.andExpect(jsonPath("$.data", hasSize(branchList.size())))
