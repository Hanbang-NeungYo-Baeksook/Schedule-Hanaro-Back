...
### 서비스 구성도
![서비스 구성도](https://github.com/user-attachments/assets/679707c8-c7df-4c88-ae26-69435833786d)

## 팀원 소개
|커밋 이모지|이름|설명|
|:---:|:---:|:---:|
|🍺|임형석|팀장 & 백엔드 총괄 및 배포 & DB 설계 및 구축|
|🥚|강능요|웹소켓 & 대면상담 api & 추천답변 알고리즘|
|🍎|김민서|지도 및 길찾기 & 프론트 배포 & 방문 상담 api|
|🐾|김예나|전화 상담 api & 상담페이지 & 전화상담 락 구현|
|🌱|남승혁|1:1문의 api & 관리자 1:1문의 페이지|
|🍀|문해빈|디자인 & 프론트 총괄 & 관리자 전화상담 api|
|🐯|이규호|예약 내역 페이지 & 영업점 추천 알고리즘 & 시연영상 제작|
